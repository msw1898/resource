...
public class ConsUtil {
    ...
    public static String KEYWORD="异常错误";
    public static String CHARSET ="UTF-8";
    public static String UTF_16 = "utf-16";
    public static String FILEPATH = "C:\\Users\\Administrator\\Desktop\\新税通补丁\\生成类文件\\";
    public static String RESIDALLPATH = FILEPATH + "\\601313psntax.properties";
}
